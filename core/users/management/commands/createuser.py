...
class Command(BaseCommand):
    ...
    def add_arguments(self, parser: CommandParser) -> None:
        ...
        parser.add_argument('--password', nargs='?', type=str, help='Set the user\'s password')
        parser.add_argument('--email', nargs='?', type=str, help='Set the user\'s email')
        parser.add_argument('username', nargs=1, type=str, help='Specify the required username')
